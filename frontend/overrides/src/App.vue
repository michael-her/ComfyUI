...
import { registerSjsxMultiChildMarkers } from '@/platform/sementic/sjsxMultiChildConnect'
import { bootstrapSementicVueNodes } from '@/platform/sementic/sementicVueNodesBootstrap'
...
onMounted(() => {
  registerSjsxMultiChildMarkers()
  void bootstrapSementicVueNodes()
